Feature: Deduplication
  ...
  Scenario Outline: Test selective depuplication filters.
    ...
    """
    CREATE TABLE test_db1.test_table3 (partition_id Int32, n Int32)
    ENGINE = MergeTree() PARTITION BY partition_id ORDER BY n
    SETTINGS min_bytes_for_wide_part=0;

    INSERT INTO test_db1.test_table3 SELECT 1, 1;
    INSERT INTO test_db1.test_table3 SELECT 1, 2;
    INSERT INTO test_db1.test_table3 SELECT 2, 1;
    INSERT INTO test_db1.test_table3 SELECT 3, 1;
    """
    ...
    """
    INSERT INTO test_db1.test_table3 SELECT 1, 2;
    INSERT INTO test_db1.test_table3 SELECT 3, 2;
    TRUNCATE TABLE system.query_log;
    """
    When we create clickhouse01 clickhouse backup
    And we execute query on clickhouse01
    ...
    SELECT count() FROM system.query_log WHERE query ilike '%FREEZE%' AND type='QueryFinish' AND query_kind='Alter'
    """
    # Note: freeze for test_table3 partition 1 and 2
    Then we get response
    """
    2
    """
    When we execute queries on clickhouse01
    """
    INSERT INTO test_db1.test_table3 SELECT 1, 5;
    INSERT INTO test_db1.test_table3 SELECT 2, 9;
    INSERT INTO test_db1.test_table3 SELECT 3, 9;
    TRUNCATE TABLE system.query_log;
    """
    When we create clickhouse01 clickhouse backup
    And we execute query on clickhouse01
