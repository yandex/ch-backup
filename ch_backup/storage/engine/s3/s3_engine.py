...
from ch_backup.storage.engine.s3.s3_client_factory import (S3ClientCachedFactory, S3ClientFactory)
...
class S3StorageEngine(PipeLineCompatibleStorageEngine, metaclass=S3RetryMeta):
    ...
    def __init__(self, config: dict) -> None:
        ...
        self._multipart_uploader = S3MultipartUploader(self._s3_bucket_name, self._s3_client_factory)
    ...
    def upload_part(self, data: bytes, remote_path: str, upload_id: str, part_num: Optional[int] = None) -> None:
        self._multipart_uploader.upload_part(data, remote_path, upload_id, part_num=part_num)
